...
// ========================================================================
// CORRECTION: highlightCode avec de vraies balises HTML
// ========================================================================
...
function handleResult(d, skipAnalysis) {
  ...
  if (d.success) { log('Compilation OK', 'ok'); if (statusDot) statusDot.className = 'dot ok'; }
  else { log('Echec: ' + errs.length + ' erreur(s)', 'err'); if (statusDot) statusDot.className = 'dot err'; }
...
// ========================================================================
// CORRECTION: renderMap avec IDs uniques pour les edges
// ========================================================================
...
function resetAll() {
  ...
  var content = document.getElementById('comp-detail-content');
  if (content) content.innerHTML = '<p>Chargez un exemple et compilez.</p>';
